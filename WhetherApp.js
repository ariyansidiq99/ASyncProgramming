    ...
    function showSkeleton() {
      document.querySelector('#weatherContainer').innerHTML = `
        <div class='card'>
          <div class='skeleton' style='height:64px;width:64px;border-radius:50%;margin:0 auto 16px'></div>
          <div class='skeleton' style='height:48px;width:120px;margin:0 auto 8px'></div>
          <div class='skeleton' style='height:20px;width:160px;margin:0 auto'></div>
        </div>`,
    }
    ...
    function renderWeather(location, weather) {
      ...
      document.querySelector('#weatherContainer').innerHTML = `
        <div class='card'>
          ...
          <div class='details'>
            <div class='detail'><div class='detail-label'>Humidity</div><div class='detail-value'>${c.relative_humidity_2m}%</div></div>
            <div class='detail'><div class='detail-label'>Wind</div><div class='detail-value'>${c.wind_speed_10m} km/h</div></div>
          </div>
        </div>`;
    }
    ...
    loadWeather('New Delhi');  // load on page open
